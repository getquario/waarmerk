...
/**
 * Whether a descriptor is half of a span this module can move. An accessor
 * `adopt` took in has no value to shift, and spreading one alongside a `value`
 * makes a descriptor `defineProperties` rejects.
 *
